...
public partial class PayrollReports_Default : System.Web.UI.Page
{
    ...
    public void session_check()
    {
        ...
        {
            case "start":
               // ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "window.onload=function(){alert('Welcome To Report Section!');};", true);
                Session["Query_Session"] = "start";
                break;
    ...
    public void pfprocess()
    {
        ...
        query = " set dateformat dmy;insert into form12 (NetPay, acno22, acno2, DLIAC, EPFAC01, PFA10, PF, EPF, FPF, SPF, SEPF, SFPF, pn_CompanyID, count,Pn_BranchID) ";
    ...
    protected void btn_Report_Click(object sender, EventArgs e)
    {
            ...
            switch (Convert.ToInt32(ddl_type.SelectedValue))
            {
                ...
                case 2:
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "window.onload=function(){alert('Select 12 Month Period');};", true);
                        break;
                    }
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('Enter all the mandatory fields'"+ ex + ");", true);
        }
    }
