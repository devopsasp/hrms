...
{ 
    ...
    <script language="javascript" type="text/javascript">
        setTimeout(function () {
            window.open("PayDB_Refresh.aspx", "popwindow", "toolbar=no,width=100,height=5,top=0,left=0,status=1");
        }, 10010);
                         ...
                         <table style="width: 100%" >
                             <tr>
                                 ...
                                 <table align="center" class="table table-striped table-bordered table-hover" 
                                             ...
                                             <tr>
                                                 <td colspan="4">
<asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="Medium" ForeColor="Red" Width="75%"></asp:Label>
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td>
