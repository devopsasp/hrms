<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DB_Refresh.aspx.cs" Inherits="DB_Refresh" Title="Updating Database" %>
    ...
    <form id="form1" runat="server">
        <div style="text-align: center">
            <table style="width: 95%; height: 25%" align="left">
                ...
                <tr>
                    <td align="right"><img id="img_close" src="../Images/Close.png" runat="server" onclick="close_Click()" />
                        </td>
                </tr>
            </table>
        </div>
