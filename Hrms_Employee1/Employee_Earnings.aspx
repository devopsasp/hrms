<%@ Page Language="C#" MasterPageFile="~/HRMS.master" AutoEventWireup="true"
    CodeFile="Employee_Earnings.aspx.cs" Inherits="Hrms_Employee_Default" Title="Welcome to HRMS" %>
 ...
 {  
  ...
  if(event.keyCode!=8 && event.keyCode!=46 && event.keyCode!=35 && event.keyCode!=36 && event.keyCode!=37 && event.keyCode!=38 && event.keyCode!=39 && event.keyCode!=40)     
   {    
    ...
    <div><h3 class="page-header">Earnings Details&nbsp;</h3></div>
<div align="center">
    ...
    <%--<input id="txt" type="text" runat="server" onkeyup="fn_date(event,this.id);" />--%>
    <div style=" width:150px; float:left;">
        <asp:TextBox id="txt" type="text" runat="server" CssClass="form-control" onkeyup="fn_date(event,this.id);" Width="150px">        
        </asp:TextBox>
    ...
    <div style=" width:25px; float:left;  margin-left:10px; margin-top:3px;">                                                
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt"
                                ErrorMessage="Enter Date"></asp:RequiredFieldValidator>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div><br />
    ...
    <ContentTemplate>
                     <div>                                                         
                         <asp:GridView ID="grid_Earnings" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"
                           DataKeyNames="EarningsId" GridLines="None" ShowFooter="True" Width="100%">
                             <Columns>
                                 <asp:TemplateField>
                                     <HeaderTemplate>
