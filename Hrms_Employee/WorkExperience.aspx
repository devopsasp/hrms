        ...
        <div style="width: 70%">
                    <table cellpadding="1%" cellspacing="1%" width="100%" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddl_PeriodFromMonth" runat="server" 
                                    class="form-control" Font-Names="Calibri" Width="100%">
                     ...
                     <div>  
                         ...
                         <asp:GridView ID="grid_WorkHistory" runat="server" AutoGenerateColumns="False" 
                             ...
                             <Columns>
                                 <asp:TemplateField>
                                     <HeaderTemplate>
                                         <table cellpadding="0" cellspacing="0" width="100%" class="dItemListContentTable">
                                             <colgroup>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td  style="width: 5%;">
                                                                <asp:ImageButton ID="imgdel"   runat="server"
                                                                 CommandName="Delete" ImageUrl="~/Images/delete_icon.jpg" Style="border: 0"/>
                                                             </td>
                                                 </tr>
                                             </tbody>
                                         </table>
