...
public partial class Hrms_Employee_Default2 : System.Web.UI.Page
{
    ...
    public void save()
    {
        ...
        Session["emp_Code"] = txtEmployeeCode.Value;
    ...
    [WebMethod]
    public static List<string> bank_auto(string bank)
    {
        List<string> result = new List<string>();
        ePayHrms.Connection.Connection Con = new ePayHrms.Connection.Connection();
        SqlConnection _Connection = Con.fn_Connection();
        ...
        while (dr.Read())
        {
            result.Add(string.Format("{0}/{1}", dr["id"], dr["val"]));
        }
        _Connection.Close();
        return result;
    ...
    [WebMethod]
    public static List<string> bankselect(string bankid)
    {
       
       List<string> result = new List<string>();
        ePayHrms.Connection.Connection Con = new ePayHrms.Connection.Connection();
        SqlConnection _Connection = Con.fn_Connection();
        SqlCommand cmd = new SqlCommand("sp_bank_select", _Connection);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        while (dr.Read())
        {
            ...
            //  txt_bankcode   .Value =   dr["v_BankCode"].ToString();
            //  txt_bankname   .Value = dr["v_BankName"].ToString();
            //  txt_branchname .Value = dr["Branch_Name"].ToString();
            //  txt_actype      .Value = dr["Account_Type"].ToString();
            //  txt_micrcode    .Value = dr["Micr_Code"].ToString();
            //  txt_ifsccode    .Value = dr["Ifsc_Code"].ToString();
            //  txt_address     .Text = dr["Address"].ToString();
            //  txt_otherinfo   .Text = dr["others"].ToString();       

            result.Add(string.Format("{0}/{1}/{2}/{3}/{4}/{5}/{6}/{7}", dr["v_BankCode"], dr["v_BankName"], dr["Branch_Name"], dr["Account_Type"], dr["Micr_Code"], dr["Ifsc_Code"], dr["Address"], dr["others"]));
        }
        _Connection.Close();
        return result;
    }
