  ...
  if(event.keyCode!=8 && event.keyCode!=46 && event.keyCode!=35 && event.keyCode!=36 && event.keyCode!=37 && event.keyCode!=38 && event.keyCode!=39 && event.keyCode!=40)     
   {    
    ...
    <table id="tbt_emp" runat="server" border="2" align="center">
        <tr>
            <td style="width: 406px; background-color: ; height: 28px;">
                <asp:Label ID="Label10" runat="server" Text="From Date" Font-Names="Calibri" 
                    ></asp:Label>
                <span style="color: #FF0000">*</span></td>
            <td style="width: 200px" align="left">
                <asp:TextBox ID="txtfrom" runat="server" onkeyup="fn_date(event,this.id);"  
                    Width="181px"  CssClass="form-control" BorderWidth="0px" MaxLength="10" 
        ...
        <tr>
            <td style="width: 406px;  background-color: ; height: 28px;">
                <asp:Label ID="Label2" runat="server" Text="Total Days" 
                    ></asp:Label>
                <span style="color: #FF0000">*</span></td>
        ...
        <tr>
            <td style="width: 406px;">
                <asp:Label ID="Label1" runat="server" Text="Destination" Font-Names="Calibri" 
                   ></asp:Label>
                <span style="color: #FF0000">*</span></td>
            <td style="margin-left: 40px; width: 200px;" align="left">
        ...
        <tr>
            <td style="width: 406px;  ">
                <asp:Label ID="Label5" runat="server" Text="Purpose" Font-Names="Calibri" 
                   ></asp:Label>
            </td>
            <td style="width: 200px" align="left">
        ...
        <tr>
            <td style="border-style: none; border-width: thin; width: 406px;  ">
                <asp:Label ID="Label6" runat="server" Text="Others" Font-Names="Calibri" 
                    ></asp:Label>
            </td>
            <td style="width: 200px" align="left">
        ...
        <td style="border-style: none; border-width: thin; width: 406px;  ">
         <asp:Label ID="Label12" runat="server" Text="Bill copy" Font-Names="Calibri" 
                ></asp:Label>
        </td>
        <td style="width: 200px" align="left">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:Button ID="ImageButton_send" runat="server" 
                    onclick="ImageButton_send_Click" Text="Submit" 
                    BorderColor="White" ForeColor="White" Font-Bold="True" 
                    style="height: 26px" Font-Names="Calibri" Width="60px" class="btn btn-success"/>
                <asp:Button ID="but_clear" runat="server"  
                    Text="Clear"  BorderColor="White" ForeColor="White" 
                    onclick="but_clear_Click" Font-Bold="True" Width="60px" 
                    Font-Names="Calibri" Height="26px" class="btn btn-success"/>
            </td>
        </tr>       
