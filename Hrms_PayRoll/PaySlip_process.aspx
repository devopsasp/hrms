...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            var r = confirm("Are you sure, you want to undo process?"); return false;
            if (r == true) {
                return true;
            }
            else {
    ...
    <div>
        <h2 class="page-header">Pay Slip Processing</h2>
    </div>
    <div style="text-align: -webkit-right; padding-right:15px">
        <asp:DropDownList ID="ddl_branch" runat="server" AutoPostBack="True" style="width: 31%;" CssClass="form-control" OnSelectedIndexChanged="ddl_branch_SelectedIndexChanged">
        </asp:DropDownList>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server"
                                        RepeatDirection="Horizontal" Enabled="False" Font-Bold="True" >
                        ...
                        <table id="Emp" runat="server">
                            <tr>
                                <td>
                                        ...
                                        <input type="checkbox" id="chkall" runat="server" onclick="javascript: fn_chkall(this.id, 'ctl00_ContentPlaceHolder1_chk_Empcode')"  />Select All Employees
                                    <div id="div1" class="scrollable-container" runat="server" style="overflow-x: auto; overflow: auto; height: 380px;">                  
                                      <asp:CheckBoxList ID="chk_Empcode" runat="server"  Width="100%"></asp:CheckBoxList>
