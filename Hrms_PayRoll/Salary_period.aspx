 ...
 {  
  ...
  if(event.keyCode!=8 && event.keyCode!=46 && event.keyCode!=35 && event.keyCode!=36 && event.keyCode!=37 && event.keyCode!=38 && event.keyCode!=39 && event.keyCode!=40)     
   ...
   function fn_validate(len,tval)
    ...
    <div><h2 class="page-header">Salary Period</h2>
        <div>
            <h3>&nbsp;</h3>
                                                    ...
                                                    style="width: 70%;">
                                                             ...
                                                             <table><tr><td>
                                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                                                                 ...
                                                                 <asp:RequiredFieldValidator ID="Selection_check" runat="server" 
                                                                    ControlToValidate="RadioButtonList1" ErrorMessage="Select any one option"></asp:RequiredFieldValidator></td></tr></table>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" 
                                                                >
                                                                <table><tr><td>
                                                                <asp:TextBox ID="Txt_spcode" runat="server" CssClass="form-control" MaxLength="15" 
                                                                    ></asp:TextBox></td><td>
                                                        ...
                                                        <tr id="row_fd" runat="server">
                                                            ...
                                                            <td colspan="2"> 
                                                                ...
                                                                <asp:TextBox ID="Txt_fdate" runat="server" onkeyup="fn_date(event,this.id);"
                                                                  CssClass="form-control" ontextchanged="Txt_fdate_TextChanged" Width="150px"></asp:TextBox>
                                                                  </div>
                                                                ...
                                                                <asp:CalendarExtender ID="CalendarExtender2" TargetControlID="Txt_fdate" 
                                                                    ...
                                                                    ControlToValidate="Txt_fdate" ErrorMessage="Enter From Date"></asp:RequiredFieldValidator></td>
                                                                    </tr></table>
                                                            </td>
                                                            ...
                                                            <td colspan="2" >
                                                               ...
                                                               CssClass="form-control" ontextchanged="Txt_tdate_TextChanged" 
                                                                  ...
                                                                  <asp:Image ID="Image2" runat="server" Text="" Width="25px" ImageUrl="~/Images/calendaricon.png" />
                                                                    ...
                                                                    runat="server" Format="dd/MM/yyyy" /></td>
                                                                    
                                                                    <td>

                                                                      <asp:RequiredFieldValidator ID="Todate_check" runat="server" 
                                                                            ControlToValidate="Txt_tdate" ErrorMessage="Enter To Date"></asp:RequiredFieldValidator></td></tr></table>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2" >
                                                            <div style=" width:150px; float:left;">
                                                                <asp:TextBox ID="txt_paydate" runat="server" onkeyup="fn_date(event,this.id);" CssClass="form-control" Width="150px"></asp:TextBox>
