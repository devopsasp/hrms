...
public partial class DB_Refresh : System.Web.UI.Page
{
    ...
    public void temp_tables()
    {
        ...
        temp_query = temp_query + " update temp_Employee set ContractRenviewDate=null where  ContractRenviewDate='1900/01/01'";
    ...
    public void Temp_employee_Create()
    {
        ...
        temp_string = temp_string + "pn_EmployeeID  int not null,EmployeeCode varchar(50),Employee_First_Name varchar(50),Employee_Middle_Name varchar(50),Employee_Last_Name varchar(50),Status Char(1),DateofBirth datetime,Password varchar(20),Gender varchar(20),Employee_Full_Name varchar(70),";
        temp_string = temp_string + "CompanyName varchar(50),BranchName varchar(50),DivisionName varchar(50),DepartmentName varchar(50),DesignationName varchar(50),CategoryName varchar(50),GradeName varchar(20),ShiftName varchar(50),JobStatusName varchar(50),LevelName varchar(50),projectsiteName varchar(50),d_Date datetime,v_Reason varchar(500),";
