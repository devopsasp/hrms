<%@ Page Language="C#" MasterPageFile="~/Master_Page/Master.master" AutoEventWireup="true"
    CodeFile="Leave_Home.aspx.cs" Inherits="Hrms_Master_Leave_Default" Title="Welcome to HRMS" %>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="35px" class="border">
                            <span class="Title">&nbsp;&nbsp; Human Resource Management System -----> Master  -----> Leave</span></td>
                    </tr>
                </table>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr valign="top">
