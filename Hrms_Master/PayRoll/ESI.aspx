<%@ Page Language="C#" MasterPageFile="~/HRMS.master" AutoEventWireup="true"
    CodeFile="ESI.aspx.cs" Inherits="Bank_Loan_Default" Title="ESI Details" %>
...
alert(document.getElementById("lbl_Error"));
    ...
    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Employee State Insurance</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <asp:RadioButtonList ID="rdo_round" runat="server" Width="223px" Font-Names="Calibri"
                                ...
                                <asp:ListItem Value="1">Rounded To Next Rupee</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                            <span style="font-family: Calibri"><span style="color: #444444"><span style="color: #6A6A6A">
                                <asp:DropDownList ID="ddl_year" runat="server" Width="100%" CssClass="form-control" ForeColor="#333333">
                                </asp:DropDownList>
                            </span></span></span>
                                            </td>
                                        </tr>
                            ...
                            <input runat="server" id="txtEligibility_Amt" onkeydown="AllowOnlyNumeric1(event);" 
                             class="form-control" type="text" tabindex="5" 
                                maxlength="7" /></td>
                                        ...
                                        <tr>
                                            <td >Employee Contribution (in %)</td>
                                            <td>
                            <input runat="server" id="txtEmployee_con" class="form-control" onkeydown="AllowOnlyNumeric1(event);"
                                 tabindex="2" maxlength="5" /></td>
                                            <td>
                                                Employer Contribution (in %)</td>
                                            <td>
