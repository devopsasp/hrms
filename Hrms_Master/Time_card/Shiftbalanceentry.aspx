            ...
            <td  width="30%" >
                ...
                <table style="width: 100%; "   class="table table-striped table-bordered table-hover"   >
                    ...
                    <tr>
                        ...
                        <td align="center">
                                    <span><span>
                                         <div class="date" id="Month_Year" >
                                    <asp:TextBox ID="txt_monyear" placeholder = "MM/YYYY" runat="server"  CssClass="form-control" Width="100%"
                                       ></asp:TextBox>    
                                      </div>                                      
                                    </span></span>
                                    </td>
            ...
            <td  width="35%" >
                ...
                <table style="width: 100%;"  class="table table-striped table-bordered" >
                    ...
                    <asp:Calendar ID="Calendar1" runat="server" CssClass="table table-hover table-striped table-responsive"
                                ondayrender="Calendar1_DayRender" ShowGridLines="true" Width="100%" OnVisibleMonthChanged="Monthchange">
                    </asp:Calendar>
                        </td>
                    </tr>
                </table>
