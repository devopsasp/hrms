<%@ Page Language="C#" MasterPageFile="~/Master_Page/Master.master" AutoEventWireup="true" CodeFile="Division.aspx.cs" Inherits="Hrms_Master_Default" Title="Welcome to HRMS" %>
...
<script type="text/javascript">
    ...
    function validate()
  {
    ...
    {
        alert("Division Name Already Exist");
    }
    function show_Error()
    {
    ...
    function fnSave()
    {   
        if(document.aspnetForm.ctl00$ContentPlaceHolder1$DivisionName.value == "")
        {
            alert("Enter Division Name");
            aspnetForm.ctl00$ContentPlaceHolder1$DivisionName.focus();
            return false;
        }                        
        else
        { 
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td id="tdComposeHeader" valign="top" align="center">
                    ...
                    <tr>
                        <td style="background-color:#5D7B9D" height="35px" class="border">
                            <span class="Title">&nbsp;&nbsp;<span 
                                style="font-family: Calibri; color:White; font-weight: bold;">Division 
                            Master</span></span></td>
                ...
                <table id="div_add" runat="server" width="100%">
                    <tr>
                        <td nowrap style="font-family: Calibri; font-size: small; color: #6A6A6A; width: 500px; font-weight: bold;" 
                            align="right">
                            &nbsp;</td>
                        <td align="left" valign="baseline" style="width: 131px">
                            <span style="font-family: Calibri; font-size: x-small">
                            <span style="color: #6A6A6A">
                            <asp:Label ID="lbl_Error" runat="server" ForeColor="Red" Font-Bold="True" 
                                Font-Names="Calibri"></asp:Label></span></span>
                            </td>
                        <td align="left">
                            &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 131px">
                            <input class="InputDefaultStyle" runat="server" id="DivisionName" 
                ...
                <table id="div_branch" runat ="server" width="100%">
                    <%--<tr valign="top">
                        <td align="center" 
                            style="font-family: Calibri; color: #993333; background-color: #DBCDCC">
                            Division List</td>
                    ...
                    <tr valign="top">
                        <td align="center" width="50%">
                            <div class="gridheight_master">
                                <asp:GridView ID="grid_Division" runat="server" AutoGenerateColumns="False" Width="100%"
                                    DataKeyNames="DivisionId" OnRowDeleting="Delete" OnRowEditing="Edit" 
                                    OnRowUpdating="Update" onrowcommand="grid_Division_RowCommand" 
                                    ...
                                    <Columns>
                                        ...
                                        <TABLE cellSpacing="0" cellPadding="0" width="100%">
                                            ...
                                            <THEAD>
                                                <TR>
                                                    <TH align="left" style="width: 80%; font-family: Calibri; color: #FFFFFF; font-weight: bold;">Division List</TH>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td id="chkid" runat="server" style="width: 10%;" align="left">
                                                                <input type="checkbox" id="Chk_Division" runat="server" /></td>
                                                            <td style="width: 80%;" nowrap>
                                                            <input runat="server" id="txtgrid" onkeypress="AllowOnlyTNS();" value='<%# Eval("DivisionName") %>' 
                                                                    style="font-family: Calibri; width: 100%; font-weight: bold; font-size:small; color: #6A6A6A;"  />
                                                                <%--<asp:TextBox runat="server" Text='<%#Eval("DivisionName")%>' ID="txtgrid" Enabled="false"></asp:TextBox>--%>
                                                            </td>
                                                            <td align="right" style="width: 5%;">
                                                                ...
                                                                align="center">
                                                                <%--<asp:Label ID="lbl" runat="server" Text="Delete"></asp:Label>--%><asp:ImageButton 
                                                                            ImageUrl="../../Images/delete_icon.gif" ID="imgdel" runat="server" 
                         ...
                         <td id="branch_body" runat="server" width="50%" align="center">
                            <div class="gridheight_master">
        ...
        <tr>
            <td align="center">
                ...
                <input id="hDivisionID" runat="server" type="hidden" value="0" /></td>
        </tr>
    </table>
</asp:Content>