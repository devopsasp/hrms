<%@ Page Language="C#" MasterPageFile="~/HRMS.master" AutoEventWireup="true" CodeFile="hierarchy_new.aspx.cs" Inherits="Hrms_Master_Employee_hierarchy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            <td id="row_branch" style="padding-left: 100px;" runat="server">Select Branch :   </td>
            <td id="row_branch1" runat="server">
                <asp:DropDownList ID="ddl_Branch" runat="server" style="width: 250px;" AutoPostBack="True" OnSelectedIndexChanged="ddl_Branch_SelectedIndexChanged"
                    CssClass="form-control">
                </asp:DropDownList>
            </td>
            <td  id="dep" runat="server" style="padding-left: 20px;">Select Department : </td>
            <td  id="dep1" runat="server">
                <asp:DropDownList ID="ddl_department" runat="server" style="width: 250px;"
                    class="form-control">
                </asp:DropDownList>
...
-->
    ...
    <script>
        function Edit(id) {
            document.cookie = "preview_EmployeeID=" + id + ";path=/";
           
            window.open('http://192.168.1.10/hrms/Hrms_Employee/EditProfile.aspx', '_blank');
        }
        ...
        function lodeh() {
            ...
            if (RoleId == 'a') {
                var b = document.getElementById("ctl00_ContentPlaceHolder1_ddl_Branch");
                Branch = b.options[b.selectedIndex].value;
            }

            var d = document.getElementById("ctl00_ContentPlaceHolder1_ddl_department");
            var did = d.options[d.selectedIndex].value;
            if (did != 0) {

                $.ajax({
                    type: 'Post',
                    url: 'hierarchy_new.aspx/Emp_select',
                    data: '{"did":' + did + ',"Branch":' + Branch + '}',
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",

                    success: function (msg) {
                        //var data = { "name": "Sunilkumar", "imageUrl": "..\/..\/Photo\/Default.JPG", "area": "Admin", "profileUrl": 0, "office": "", "tags": "", "positionName": "Admin", "children": [{ "name": "Padmaja", "imageUrl": "..\/..\/Photo\/Default.JPG", "area": "HR", "profileUrl": 860, "office": "padmaja@gmail.com", "tags": "04422520213", "positionName": "HR", "children": [{ "name": "Arul kumar", "imageUrl": "..\/..\/Photo\/01.jpg", "area": "Developer", "profileUrl": 870, "office": "arul@hesperus.com", "tags": "9585008655", "positionName": "Developer" }, { "name": "Karthik", "imageUrl": "..\/..\/Photo\/84.jpg", "area": "Developer", "profileUrl": 870, "office": "Karthik@gmail.com", "tags": "", "positionName": "Developer" }] }, { "name": "Shobha", "imageUrl": "..\/..\/Photo\/002.jpg", "area": "HR", "profileUrl": 860, "office": "shobha@haspl.com", "tags": "", "positionName": "HR" }, { "name": "Vidhurar", "imageUrl": "..\/..\/Photo\/Default.JPG", "area": "Employee", "profileUrl": 860, "office": "", "tags": "", "positionName": "Employee" }] };
            ...
            function drawOrganizationChart(params) {
                ...
                var svg = d3.select(attrs.selector)
                  .append("svg")
                  .attr("width", "100%")
                  .attr("height", attrs.height-100)
                  .call(zoomBehaviours)
                  .append("g")
                  .attr("transform", "translate(" + attrs.width / 3 + "," + 20 + ")");
                ...
                function update(source, param) {
                    ...
                    function tooltipContent(item) {
                        ...
                        strVar += "";
                        strVar += "      <i class=\"fa fa-envelope\"></i> <a class=\"office\" target=\"_blank\"  href='mailto:" + item.office + "' > " + item.office + "<\/a><br/>";
                        strVar += "     <i class=\"fa fa-phone\" style=\"font-size:15px\"><\/i>";
                        strVar += "       <span class=\"office\">  " + item.tags + "<\/span><br/> ";
                        strVar += "     <button class='btn1 btn-tooltip-department' onclick='Edit(" + item.Emp_id + ");'>Edit " + item.name + "</button> <\/div>";
