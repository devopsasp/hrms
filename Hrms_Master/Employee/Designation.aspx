<%@ Page Language="C#" MasterPageFile="~/Master_Page/Master.master" AutoEventWireup="true" CodeFile="Designation.aspx.cs" Inherits="Hrms_Master_Default2" Title="Welcome to HRMS" %>
        ...
        <tr valign="top">
            <td id="tdComposeHeader" valign="top" align="center">
                    ...
                    <tr>
                        <td style="background-color:#5D7B9D" height="35px" class="border">
                            <span class="Title">&nbsp;&nbsp;<span 
                                style="font-family: Calibri; color:White; font-weight: bold;">Designation 
                            Master</span></span></td>
                ...
                <table id="des_add" runat="server" width="100%">
                    ...
                    <tr>
                        <td nowrap style="font-family: Calibri; font-size: small; color: #6A6A6A; width: 505px; font-weight: bold;" 
                            align="right">
                            Designation Name</td>
                        <td align="left" style="width: 129px">
                            <input class="InputDefaultStyle" runat="server" id="DesignationName" 
                        ...
                        <td align="left">
                            <asp:ImageButton ImageUrl="~/Images/Add.png" onmouseover="this.src='../../Images/Addover.png';" onmouseout="this.src='../../Images/Add.png';" ID="Button1" runat="server" OnClientClick="return fnSave();"
                                Text="Add" OnClick="Button1_Click1" ImageAlign="AbsMiddle" /></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr valign="top">
                        <td align="center" width="50%">
                            <div class="gridheight_master">
                                <asp:GridView ID="grid_Designation" runat="server" AutoGenerateColumns="False" Width="100%"
                                    DataKeyNames="DesignationId" OnRowDeleting="Delete" OnRowEditing="Edit" 
                                    OnRowUpdating="Update" onrowcommand="grid_Designation_RowCommand" 
                                    ...
                                    <Columns>
                                        ...
                                        <TABLE cellSpacing="0" cellPadding="0" width="100%">
                                            ...
                                            <THEAD>
                                                <TR>
                                                    <TH align="left" style="width: 80%; font-family: Calibri; color: #FFFFFF; font-weight: bold;">Designation List</TH>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td id="chkid" runat = "server" style="width: 10%;" align="left">
                                                                <input type="checkbox" id="Chk_Designation" runat="server" /></td>
                                                            <td style="width: 80%;" nowrap>
                                                            <input  runat="server" id="txtgrid" onkeypress="AllowOnlyTNS();" 
                                                                    value ='<%# Eval("DesignationName") %>' 
                                                                    style="font-family: Calibri; font-size:small; width: 100%; color: #6a6a6a" Height="21px" />
