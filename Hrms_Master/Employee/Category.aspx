<%@ Page Language="C#" MasterPageFile="~/Master_Page/Master.master" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="Hrms_Master_Default4" Title="Welcome to HRMS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function validate()
  {
    ...
    function fnSave()
    {   
        if(document.aspnetForm.ctl00$ContentPlaceHolder1$CategoryName.value == "")
        {
            alert("Enter Category Name");
            aspnetForm.ctl00$ContentPlaceHolder1$CategoryName.focus();
            return false;
        }                        
        else
        { 
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td id="tdComposeHeader" valign="top" align="center">
                    ...
                    <tr>
                        <td style="background-color:#5D7B9D" height="35px" class="border">
                            <span class="Title">&nbsp;&nbsp;<span 
                                style="font-family: Calibri; color:White; font-weight: bold;">Category 
                            Master</span></span></td>
                ...
                <table id="cat_add" runat="server" width="100%">
                <tr><td align="center" colspan="4" style="height: 26px"><asp:Label ID="lbl_Error" runat="server" 
                    ...
                    <tr>
                        <td nowrap 
                            ...
                            style="font-family: Calibri; font-size: small; color: #6A6A6A; width: 503px; font-weight: bold;" 
                            align="right">
                            Category Name&nbsp;&nbsp; </td>
                        <td align="left" valign="baseline" style="width: 130px">
                            <input class="InputDefaultStyle" runat="server" id="CategoryName" 
                ...
                <table id="cat_branch" runat="server" width="100%">
                   
                    <tr valign="top">
                        <td align="center" width="50%">
                            <div class="gridheight_master">
                                <asp:GridView ID="grid_Category" runat="server" AutoGenerateColumns="False" Width="100%"
                                    DataKeyNames="CategoryId" OnRowDeleting="Delete" OnRowEditing="Edit" 
                                    OnRowUpdating="Update" onrowcommand="grid_Category_RowCommand" 
                                    ...
                                    <Columns>
                                        ...
                                        <TABLE cellSpacing="0" cellPadding="0" width="100%">
                                            ...
                                            <THEAD>
                                                <TR>
                                                    <TH align="left" style="width: 80%; font-family: Calibri; color: #FFFFFF; font-weight: bold;">Category List</TH>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td id="chkid" runat="server" style="width: 10%;" align="left">
                                                                <input type="checkbox" id="Chk_Category" runat="server" /></td>
                         ...
                         <td id="branch_body" runat="server" align="center" width="50%">
                            <div class="gridheight_master">
                                <asp:GridView ID="grid_Branch" runat="server" AutoGenerateColumns="False" Width="80%"
        ...
        <tr>
            <td align="center">
                ...
                <input id="hCategoryID" runat="server" type="hidden" value="0" /></td>
        </tr>
        <tr valign="top">
            <td align="center" valign="top">
                &nbsp;<asp:Label ID="Error" runat="server" Width="50%" CssClass="Error" 
                    ForeColor="Red" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Small"></asp:Label></td>
        </tr>
