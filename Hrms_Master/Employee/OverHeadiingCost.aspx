<%@ Page Language="C#" MasterPageFile="~/HRMS.master"  AutoEventWireup="true" CodeFile="OverHeadiingCost.aspx.cs" Inherits="Hrms_Master_Employee_OverHeadiingCost" %>
   ...
   <table width="100%" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td id="tdComposeHeader" valign="top" align="center">
                    ...
                    <tr>
                        <td style="background-color:#5D7B9D" height="35px" class="border">
                            <span class="Title">&nbsp;&nbsp;<span 
                                style="font-family: Calibri; color:White; font-weight: bold;">OverHeadingCost</span></span></td>
                ...
                <table id="level_add" runat="server"  width="100%">
                    ...
                    <tr>
                        <td nowrap 
                            ...
                            align="right">
                            OverHeadingCost Name</td>
                        <td align="left" style="width: 126px">
                            <input class="InputDefaultStyle" runat="server" id="CostName" 
                ...
                <table id="Cost_branch" runat="server" width="100%">
                   
                    <tr valign="top">
                        <td align="center" width="50%">
                            <div class="gridheight_master">
                                <asp:GridView ID="grid_OverHeadingCost" runat="server" 
                                    AutoGenerateColumns="False" Width="100%"
                                    DataKeyNames="OverHeadingCostId" OnRowDeleting="Delete" OnRowEditing="Edit" 
                                    OnRowUpdating="Update" onrowcommand="grid_OverHeadingCost_RowCommand" 
                                    ...
                                    <Columns>
                                        ...
                                        <TABLE cellSpacing="0" cellPadding="0" width="100%">
                                            ...
                                            <THEAD>
                                                <TR>
                                                    <TH align="left" style="width: 80%; font-family: Calibri; color: #FFFFFF; font-weight: bold;">OverHeadingCost List</TH>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td id="chkid" runat="server" style="width: 10%;" align="left">
                                                                <input type="checkbox" id="Chk_Cost" runat="server" /></td>
                                                            <td style="width: 80%;" nowrap>
                                                            <input runat="server" id="txtgrid" onkeypress="AllowOnlyTNS();" 
                                                                    value='<%# Eval("OverHeadingCostName") %>' 
                                                            ...
                                                            <td align="right" style="width: 5%;" nowrap>
                                                                ...
                                                                align="center">
                                                                <%--<asp:Label ID="lbl" runat="server" Text="Delete"></asp:Label>--%><asp:ImageButton ImageUrl="../../Images/delete_icon.gif" ID="imgdel" runat="server" CommandName="Delete" />
                                                             </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                         ...
                         <td id="branch_body" runat="server" align="center" width="50%">
                            <div class="gridheight_master">
                                <asp:GridView ID="grid_Branch" runat="server" AutoGenerateColumns="False" Width="50%"
                                    ...
                                    CellPadding="4" ForeColor="#333333" GridLines="None" 
                                    onselectedindexchanged="grid_Branch_SelectedIndexChanged" 
                                    ShowFooter="True">
                                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                    <Columns>
                                        <asp:TemplateField>
        ...
        <tr>
            <td align="center">
                ...
                <input id="hCostID" runat="server" type="hidden" value="0" /></td>
        </tr>
    </table>
