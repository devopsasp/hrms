<%@ Page Language="C#" MasterPageFile="~/Master_Page/Master.master"
    AutoEventWireup="true" CodeFile="Common_Home.aspx.cs" Inherits="Hrms_Master_Common_Default"
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="35px" class="border">
                            <span class="Title">&nbsp;&nbsp; Human Resource Management System -----> Master  -----> Common</span></td>
                    </tr>
                </table>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr valign="top">
                                ...
                                <tr>
                                    <td width="100%">
                                        <table width="100%" align="center" class="InputTextStyle">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <img src="../../Images/Welcome_logo.JPG" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    &nbsp;</td>
