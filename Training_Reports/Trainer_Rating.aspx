<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Master_Page/EmployeeMaster.master" CodeFile="Trainer_Rating.aspx.cs" Inherits="Training_Reports_Trainer_Rating" %>
...
<table cellpadding="5" cellspacing="1" width="100%" id="tbl_details" runat="server">
     <tr id="Tr9" runat="server">
        ...
        CssClass="roundedbox"  style="height: 25px; font-family:Calibri;font-size: small;color: #808080;" 
                                Width="200px" onselectedindexchanged="ddl_employee_SelectedIndexChanged">
