            ...
            $.each(items, function (a, b) {
                if (id == 0) {
                    ...
                    if (obj.lstMenu && obj.lstMenu.length > 0) {
                        ...
                        var li = $('<li><a id="' + b.MenuId + '"  href="/hrms' + obj.MenuLink + '">' + obj.MenuName + '<span class="caret"></span></a></li>');
                    }
                    li.appendTo(parent);
                    if (obj.lstMenu && obj.lstMenu.length > 0) {
                        var ul = $('<ul class="nav nav-second-level"></ul>');
                    ...
                    if (b.lstMenu && b.lstMenu.length > 0) {
                        ...
                        var li = $('<li><a  id="' + b.MenuId + '" href="/hrms' + b.MenuLink + '">' + b.MenuName + '</a></li>');
                    }
                    li.appendTo(parent);
                    if (b.lstMenu && b.lstMenu.length > 0) {
                        var ul = $('<ul class="nav nav-third-level "></ul>');
